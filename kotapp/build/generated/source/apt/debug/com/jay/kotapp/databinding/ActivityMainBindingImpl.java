...
import com.jay.kotapp.R;
import com.jay.kotapp.BR;
...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.user == variableId) {
            setUser((com.jay.kotapp.bean.User) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUser(@Nullable com.jay.kotapp.bean.User User) {
        this.mUser = User;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.jay.kotapp.bean.User user = mUser;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.first, userFirstName);
